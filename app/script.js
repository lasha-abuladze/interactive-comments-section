...
class CommentCl {
    constructor(username, userImg, content, createdAt, replies, score){
        this.username = username;
        this.userImg = userImg;
...
class ReplyCl extends CommentCl {
    constructor(username, userImg, content, createdAt, replies, score, replyingTo) {
        super(username, userImg, content, createdAt, replies, score);
...
const getdata = async function() {
    ...
    if(data.comments) {
        data.comments.forEach(el => {
            const comment = new CommentCl(el.user.username, el.user.image.png, el.content, el.createdAt, el.replies, el.score);
    ...
    if(commentsArray) {
        commentsArray.forEach(el => renderComment(el));
    }
